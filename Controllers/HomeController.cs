...
public class HomeController : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        Cliente cliente1=new Cliente(01,"Fulano de Tal","123.456.789-11","wilson.barros6@aluno.senai.br","Rex");
        ...
        Cliente cliente5=new Cliente(05,"Grace Hopper","911.456.789-00","grace.hopper@cobol.com","Loboc");

        // Lista de Clientes e os atribui
